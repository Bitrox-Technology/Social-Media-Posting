...
import { Eye, EyeOff, Lock, Mail, User, BrainCircuit } from 'lucide-react';
...
const Signup: React.FC = () => {
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      setErrors({ submit: err.data?.message || 'Failed to create account' });
    } finally {
      setSubmitting(false);
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-50 dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-800 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600 dark:text-gray-300">
          Sign up to manage your admin panel
        </p>
      </div>
